...
/// hotfix_insuffient_gas_for_mft_resolve_transfer, increase from 20T to 25T for AS token contract.
pub const GAS_FOR_RESOLVE_TRANSFER: Gas = 25_000_000_000_000;

pub const GAS_FOR_FT_TRANSFER_CALL: Gas = 25_000_000_000_000 + GAS_FOR_RESOLVE_TRANSFER;

/// Amount of gas for fungible token transfers, 20T to support AS token contract.
