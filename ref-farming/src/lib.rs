...
mod tests {
    ...
    use near_sdk::{testing_env, Balance, BlockHeight};
    ...
    fn deposit_reward(context: &mut VMContextBuilder, contract: &mut Contract) {
        testing_env!(context
    ...
    fn test_basics() {
        ...
        assert_eq!(farm_info.reward_token, AccountId::new_unchecked("charlie".to_string()));
        ...
        println!(
            "accounts(0) total used: {}, deposited: {}",
            sb.total.0, sb.available.0
        );
        ...
        println!(
            "accounts(3) total used: {}, deposited: {}",
            sb.total.0, sb.available.0
        );
